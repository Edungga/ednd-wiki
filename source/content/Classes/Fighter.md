...
- (B) Studded Leather Armor, Scimitar, Shortsword, Longbow, 20 Arrows, Quiver, Dungeoneer's Pack, and 11 GP; or 
- (C) 155 GP
...
| 3rd   | +2                | 3              | [[Fighter#Level 3 Martial Archetype\|Martial Archetype]]                                                                                      |
| 4th   | +2                | 4              | [[Fighter#Level 4 Ability Score Improvement\|Ability Score Improvement]]                                                                      |
...
You gain proficiency with one type of s Skill or type of Artisan Tools of your choice.
...
Your Weapon Attack Rolls have [[Conditions#Luck (Buff)|Luck 1]]
...
As a Bonus Action, you Magically manifest an Echo of yourself in an unoccupied space you can see within 15ft of you. This Echo is a magical, translucent, grey image of you that lasts until it is destroyed, until you dismiss it as a Bonus Action, until you manifest another Echo, or until you're Incapacitated.

Your Echo has AC 14 + your Proficiency Bonus, 1 Hit Point, and Immunity to all Conditions. If it has to make a Save, it uses your Save bonus for the roll. It is the same size as you, and it occupies its space. 
On your turn, you can mentally command the Echo to move up to 30ft in any direction (no action required). If your Echo is ever more than 30ft from you at the end of your turn, it is destroyed. 

Additionally, you are able to do the following with your Echo:
- **Swap**. As a Bonus Action, Magically Teleport, Magically swapping places with your Echo at the cost of 15ft of movement.
- **Attack**. When you take the Attack Action on your turn, any Attack you make can originate from you or the Echo.
- **Opportunity Attacks**. When a creature that you can see breaks Melee Range with your Echo, you can use your Reaction to make an Opportunity Attack against that creature as if you were in the Echo’s space.
- 
...
- **Grow**. Your size increases by 1, along with anything you are wearing. If you lack the room to grow, your size doesn't change.
- **Strong**. You have advantage on Strength checks and Strength saving throws.
- **Powerful**. Once on each of your turns, one of your attacks with a weapon or an unarmed strike can deal an extra 1d6 damage to a target on a hit.
...
Your intensity in battle can shield you and help you strike true. As a Bonus Action you can give yourself Advantage on all Weapon Attacks until the end of the current turn. When you do so, you also gain 5 Temporary Hit Points. 

The number of Hit Points increases when you reach certain levels in this class, increasing to 10 at 10th level and 15 at 15th level.
...
**Ambush**. When you make a DEX (Stealth) check or an Initiative Check, roll one Superiority Die and add the die to the roll.

**Bait and Switch**. Swap places with a willing creature within 5 ft of you. This Movement doesn't provoke Opportunity Attacks. Roll the Superiority Die. Until the start of your next turn, you or the other creature (your choice) gains a bonus to AC equal to the number rolled.

**Brace**. When a creature you can see moves into the Reach you have with the Melee Weapon you're wielding, you can make one Attack against the creature, using that Weapon. Add the Superiority Die to the damage roll.

**Commander's Strike**. As a Bonus Action, direct one of your Allies who can see or hear you within 30ft to immediately use its Reaction to make one Weapon Attack, adding the Superiority Die to the damage roll.
...
**Disarming Attack**. When you hit a creature with a Weapon Attack, you can attempt to disarm the target, forcing it to drop one item of your choice that it's holding. You add the Superiority Die to the Attack's damage roll, and the target must make a STR Save. On a failed save, it drops the object you choose. The object lands at its feet.

**Distracting Strike**. When you hit a creature with a Weapon Attack, you can attempt to distract the creature, giving your Allies an opening. You add the Superiority Die to the Damage roll. The next Attack against the target by an attacker other than you has Advantage if the Attack is made before the start of your next turn.

**Evasive Footwork**. When you move, you can expend one Superiority Die, rolling the die and adding the number rolled to your AC until you stop moving.

**Feinting Attack**. Choosing one creature within 5ft of you as your target. You have Advantage on your next Attack against that creature this turn. If that Attack hits, add the Superiority Die to the Damage roll.
...
**Lunging Attack**. When you make a Melee Weapon Attack on your turn, you can increase your reach for that attack by 5 feet. If you hit, you add the Superiority Die to the Damage roll.
...
**Pushing Attack**. When you hit a creature with a Weapon Attack, you can attempt to drive the target back. You add the Superiority Die to the Damage roll, and if the target is at most one size larger than you, it must make a STR Save. On a failed Save, you push the target up to 15ft away from you.
...
**Rally**. As a bonus action, you bolster the resolve of one of your companions. All Allies within 30ft gain Superiority Die + your Charisma modifier Temp HP.

**Riposte**. When a creature misses you with a Melee Attack, you can make a Melee Weapon Attack against the creature. If you hit, you add the Superiority Die to the Damage.

**Stalwart Defender**. When an Ally within 5ft of you is targeted by an Attack, as a Reaction you can impose yourself and become the target of the Attack instead. Both you and the Ally gain Temp HP equal to your Superiority Die.

**Sweeping Attack**. When you hit a creature with a Melee Weapon Attack, you can attempt to damage another creature with the same Attack. Choose another creature within 5ft of the original target and within your Reach. If the original Attack roll would hit the second creature, it takes Damage equal to the number you roll on your Superiority Die. The damage is of the same type dealt by the original Attack.

**Superior Willpower**. When you make an INT, a WIS, or a CHA Save, as a Reaction you can add a Superiority Die to the result. You can use this Manoeuvre after you roll, but before you know if you succeed or fail.
