...
**Burning Seals**. When an Interdicted Creature you can see within 30ft takes damage from any source other than a Seal Burned, you can Burn any number of Seals you placed on them to deal 1d6 Fire or Necrotic Damage to that creature per Seal Burned (no action required). You deal this damage immediately after the triggering damage. Burning a Seal doesn’t require an Action, but you can’t do so while [[Conditions#Incapacitated (Condition)|Incapacitated (Condition)]]. Once a Seal is Burned, it immediately vanishes. The Seal Damage increases as you gain Illrigger levels, as indicated on the Illrigger table. 
...
You can instinctively speak, read, and write Infernal. In addition, you can speak two other languages of your choice, but you can’t read or write them.
...
| Illrigger Level | Cantrips Known | Spells Known | 1st | 2nd | 3rd | 4th |
| --------------- | -------------- | ------------ | --- | --- | --- | --- |
| 3rd             | 2              | 3            | 2   | -   | -   | -   |
| 4th             | 2              | 4            | 3   | -   | -   | -   |
| 5th             | 2              | 4            | 3   | -   | -   | -   |
...
### Level 3: Charm Enemy
When you use your bonus action to place a seal on a Humanoid, you can attempt to charm them. The target must succeed on a CHA Save or be [[Conditions#Charmed (Debuff)|Charmed (Debuff)]] by you for 1 hour or until you or your companions do anything harmful to them. While charmed, the target regards you as a friendly acquaintance. When the [[Conditions#Charmed (Debuff)|Charmed (Debuff)]] ends, the target knows they were charmed by you. When you use this bonus action, you can additionally burn one or more seals on one or more other interdicted Humanoids within 30 feet of you, attempting to charm those targets as well. After taking damage from the burned seals, each of those targets must succeed on a CHA Save or be under the same [[Conditions#Charmed (Debuff)|Charmed (Debuff)]] effect. You can use this feature a number of times equal to your CHA modifier (min 1), and you regain all expended uses when you finish a long rest
...
#### Turncoat
As an action, you wield your manipulative tongue against your enemies. You choose a number of enemy creatures up to your proficiency bonus within 60 feet of you who can hear you. Each target must succeed on a CHA Save or use their Reaction to make a weapon attack against a single target of your choice. A creature affected by this feature can’t attack themself.
...
gains temporary hit points equal to the damagedealt by the seals to the interdicted creature
