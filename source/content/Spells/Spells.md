...
# Cantrips
<!-- QueryToSerialize: table School, spell-list as "Spell List"
FROM "Spells"
WHERE spell-circle = "Cantrip"
FLATTEN spell-list
-->
<!-- SerializedQuery: table School, spell-list as "Spell List" FROM "Spells" WHERE spell-circle = "Cantrip" FLATTEN spell-list -->
