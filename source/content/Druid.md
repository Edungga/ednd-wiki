...
- (A) Leather Armor, Shield, Sickle, Druidic Focus (Quarterstaff), Explorer's Pack, Herbalism kit, 9 GP; or 
- (B) 50 GP
## Multiclassing
...
| ----- | ----------------- | ---------------------------------------------------------------------------------------- | -------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1st   | +2                | [[#Level 1 Druidic Initiate\|Druidic Initiate]], [[#Level 1 Spellcasting\|Spellcasting]] | 2        | 2   | -   | -   | -   | -   | -   | -   | -   | -   |
| 2nd   | +2                |                                                                                          | 2        | 3   | -   | -   | -   | -   | -   | -   | -   | -   |
| 3rd   | +2                |                                                                                          | 2        | 4   | 2   | -   | -   | -   | -   | -   | -   | -   |
| 4th   | +2                |                                                                                          | 3        | 4   | 3   | -   | -   | -   | -   | -   | -   | -   |
| 5th   | +3                |                                                                                          | 3        | 4   | 3   | 2   | -   | -   | -   | -   | -   | -   |
...
**Known Forms**. You know four Beast forms for this feature, chosen from among [[Wild Shapes#CR 1/4|Wild Shapes CR 1/4]] that lack a Fly Speed. 
...
You have a mystical connection to the land of your Grove that grants you features at certain Druid levels.
...
If you have no [[#Level 2 Primal Surge|Primal Surges]] left, you can expend a Spell Slot of any level to gain [[#Level 2 Primal Surge|Primal Surges]] equal to the Spell Slot Level expended (no action required).
...
| **TRAITS**<br>**Aura of Starvation**. At the end of the Wendigos turn, all enemies must make a CON save against your Spell Save DC. On a failure they are [[Conditions#Paralysed (Debuff)\|Paralysed (Debuff)]] until the end of your next turn.                                                                             |
| **ACTIONS**<br>**Multiattack** (*Requires Druid Level 5*). Can make two Attacks: one with its Bite and one with its Claws.<br>**Bite**. Melee Weapon Attack: +7 to hit, reach 5ft, one target. Hit: 1d8 + 4 Piercing Damage<br>**Claw**. Melee Weapon Attack: +7 to hit, reach 5ft, one target. Hit: 2d4 + 4 Slashing Damage |
...
| **BONUS ACTIONS**<br>**Shapchanger**. Once you have expended the use of Wild Shape to turn into this form, you can revert back to your normal form and back into this form without expending additional Wild Shape uses for the normal Wild Shape duration.                                                                                                                  |
| **REACTIONS**<br>**test**.                                                                                                                                                                                                                                                                                                                                                   |
...
| **ACTIONS**<br>**Multiattack** (*Requires Druid Level 5*). Can make two Attacks: one with its Beak and one with its Claws.<br>**Beak**. Melee Weapon Attack: your Spell Attack Modifier to hit, reach 5ft, one target. Hit: 1d10 + 5 Piercing Damage<br>**Claw**. Melee Weapon Attack: your Spell Attack Modifier to hit, reach 5ft, one target. Hit: 2d6 + 5 Slashing Damage |


#### Displacer Beast

| Displacer Beast - Wild Shape                                                                                                                                                                                                                                                                              |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| *Large Monstrosity*                                                                                                                                                                                                                                                                                       |
| **Armour Class**: 10 + your WIS modifier                                                                                                                                                                                                                                                                  |
| **Hit Points**: 30 + five times your Druid level                                                                                                                                                                                                                                                          |
| **Speed**: 40ft Walk                                                                                                                                                                                                                                                                                      |
...
| **ACTIONS**<br>**Multiattack** (*Requires Druid Level 5*). Can make two Tentacle Attacks<br>**Tentacle**. Melee Weapon Attack: your Spell Attack Modifier to hit, reach 10ft, one target. Hit: 2d6 + 4 Piercing Damage                                                                                    |
