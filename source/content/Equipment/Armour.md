...
SORT Cost
-->
<!-- SerializedQuery: table ac-bonus AS "AC Bonus", armour-stealth AS "Armour Stealth", Cost WHERE contains(tags, "Light-Armour") SORT Cost -->
...
SORT Cost
-->
<!-- SerializedQuery: table ac-bonus AS "AC Bonus", armour-stealth AS "Armour Stealth", Cost WHERE contains(tags, "Medium-Armour") SORT Cost -->
