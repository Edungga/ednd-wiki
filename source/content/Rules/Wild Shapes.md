...
| **TRAITS**<br>Venom (Once ). When the Centipede hits with its Bite, it can force the target to make a Constitution saving throw (DC 11). On a failure, it takes 3d6 poison damage and is Poisoned. On a success, it only takes half damage.<br><br>A Poisoned creature repeats this saving throw at the end of each of its turns, ending the effect on a success. On a failure, it takes 1d6 poison damage. If this reduces it to 0 hit points, it is stable, but Paralyzed, while at 0 hit points. |
| **ACTIONS**<br>**Beast's Strike**. Melee Attack Roll: 4+PB, reach 5 ft. Hit: 1d6+4 Bludgeoning damage.                                                                                                                                                                                                                                                                                                                                                                                              |
